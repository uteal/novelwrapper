 ...
 * @param {object} params.$
 * @param {object} params.ext
 * @param {(object|object[])} params.callbacks
 * @param {boolean} params.devMode
 * @param {number} params.stepTime
 * @param {string} params.cssPrefix
 * @param {string} params.imagesPath
 * @param {string} params.imagesType
 * @param {string} params.firstScene
 * @param {boolean} params.skipRestoring
 * @param {(string|HTMLElement)} params.appendTo
 * @param {object} params.delays
 * @param {('left'|'right')} params.defaultAlign
 * @param {RegExp} params.multiLangSplitRegex
 * @param {number} params.language
 */
